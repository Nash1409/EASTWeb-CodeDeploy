package version2.prototype.indices.ModisLSTV6;
...
public class ModisLSTV6Mean extends IndicesFramework{
    private final int DAY_LST;
    private final int NIGHT_LST;

    public ModisLSTV6Mean(List<File> inputFiles, File outputFile, Integer noDataValue)
    {
